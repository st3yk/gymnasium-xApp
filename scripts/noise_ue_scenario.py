...
class multi_ue_scenario(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.ue3_path_loss_db = ue3_path_loss_db = 10
        self.ue2_path_loss_db = ue2_path_loss_db = 10
        self.ue1_path_loss_db = ue1_path_loss_db = 10
        ...
        self._ue1_path_loss_db_range = Range(0, 100, 1, 10, 200)
        ...
        self._ue3_path_loss_db_range = Range(0, 100, 1, 10, 200)
        ...
        self.connect((self.blocks_add_xx_1, 0), (self.zeromq_rep_sink_0_0, 0))
        self.connect((self.blocks_add_xx_1_0, 0), (self.blocks_add_xx_0, 1))
        self.connect((self.blocks_multiply_const_vxx_0, 0), (self.blocks_add_xx_0, 0))
        self.connect((self.blocks_multiply_const_vxx_0_0, 0), (self.blocks_add_xx_1_0, 1))
        self.connect((self.blocks_multiply_const_vxx_0_1, 0), (self.zeromq_rep_sink_0, 0))
        self.connect((self.blocks_multiply_const_vxx_0_1_1, 0), (self.blocks_add_xx_1, 0))
